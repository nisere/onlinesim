...
public class MyVm extends Vm {
	 ...
	 * @param userId the id of this VM's owner
	 * @param mips the mips of this VM
	 * @param numberOfPes the number of CPUs of this VM
	 * @param ram the amount of RAM (in MB)
	 * @param bw the amount of bandwidth (in Mbps)
	 * @param size the size the VM image size (the amount of storage it will use, at least initially)
	 * 			(in MB)
	 * @param vmm the virtual machine monitor that manages this VM
	 * @param cloudletScheduler the cloudletScheduler policy for cloudlets scheduling
     */
	public MyVm(
			final int id, 
			final int userId, 
	 ...
	 * @return the interval of time for which the cost of this VM is applied (in seconds)
	 */
	 ...
	 * @param seconds the interval of time for which the cost of this VM is applied 
	 ...
	 * @param cost the cost of this VM applied per interval of time;
	 * 			must be >= 0
	 * @return <code>true</code> if it is successful, <code>false</code> otherwise
	 */
